...
A command-line tool that _quickly_ generates _easy-to-maintain_ websites for **technical documentation**, following [Barchart's](https://www.barchart.com/solutions) standards for content, style, and layout.
